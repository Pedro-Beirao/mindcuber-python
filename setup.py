...
requirements = ["ev3_dc","kociemba","python-opencv","git+https://github.com/dwalton76/rubiks-cube-tracker.git","git+https://github.com/dwalton76/rubiks-color-resolver.git"]
