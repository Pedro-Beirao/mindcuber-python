...
requirements = ["ev3_dc","kociemba","python-opencv","-e git+https://github.com/dwalton76/rubiks-cube-tracker.git","-e git+https://github.com/dwalton76/rubiks-color-resolver.git"]
