...
requirements = ["ev3_dc","kociemba","python-opencv","rubiks-cube-tracker @ https://github.com/dwalton76/rubiks-cube-tracker@master","rubiks-color-resolver @ https://github.com/dwalton76/rubiks-color-resolver@master"]
